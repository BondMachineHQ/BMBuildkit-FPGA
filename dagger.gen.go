...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Bmbuildkit":
		...
		case "ContainerEcho":
			...
			return (*Bmbuildkit).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Bmbuildkit
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Bmbuildkit).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.CurrentModule().
			WithObject(
				dag.TypeDef().WithObject("Bmbuildkit").
					WithFunction(
